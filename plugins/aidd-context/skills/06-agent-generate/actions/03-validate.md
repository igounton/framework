...
2. **Shape.** Confirm each file matches its target format (`@../references/tool-paths.md`), a confirmed tool's, or the canonical form in plugin source, and carries the name, description, and body.
