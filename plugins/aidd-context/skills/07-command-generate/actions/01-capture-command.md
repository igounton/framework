...
4. **Place.** Ask the user where the command should live. An optional ordering convention is in `@../references/command-authoring.md` if they want it, but never impose a location.
