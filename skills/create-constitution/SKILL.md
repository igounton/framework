...
description: >-
  Generate a project constitution from an initial idea and business context.
  Use when starting a new project, defining vision, objectives, and constraints.
---
...
1. Save as `aidd_docs/memory/constitution.md`
...
| -------- | ----------------------------------------- | ---------------------------- |
| Template | `aidd_docs/templates/pm/constitution.md`  | Constitution template below  |
