...
description: >-
  Analyze an existing codebase and generate a pragmatic system overview.
...
4. Save as `aidd_docs/memory/system_overview.md`
...
| ------ | ------------------------------------------ | ----------------------- |
| Output | `aidd_docs/memory/system_overview.md`     | Generated overview      |
