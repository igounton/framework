---
name: create-change-brief
description: >-
  Generate a change brief documenting the as-is to to-be gap for brownfield evolution.
  Use when you need to clarify what changes on an existing system and what stays the same.
---
...
3. Save as `aidd_docs/tasks/change-brief-[name].md`
