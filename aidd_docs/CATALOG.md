...
Aggregated index of every skill across the framework. Auto-generated from each plugin's `SKILL.md` `description` frontmatter; regenerate after adding or removing a skill.
